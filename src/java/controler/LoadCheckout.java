    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (httpSession.getAttribute("user") != null) {
            ...
            if (criteria2.list().isEmpty()) {
                jsonObject.addProperty("message", "current address not found.");
            } else {
            ...
            //pack cityList to jsonObject
            jsonObject.add("cityList", gson.toJsonTree(cityList));

            //pack cartItem to json object
            ...
            jsonObject.addProperty("message", "Not signIn");
        }
